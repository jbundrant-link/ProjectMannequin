...
Current cross-world verification after the World Warrior Sparring Supply Crate, Pavilion Rack Chest, Grand Tournament Champion's Trophy Podium, Champion's Lantern Urn, Judge's Laurel Fan, walk-cycle QA expansion, and director-level PushZone integration: 244/244 world-run assertions plus 53/53 stage-hazard assertions (297/297 aggregate), with exact Rookie, Striker, Grappler, Kenzo, Makoto, Tetsu, training dummy, supply crate, rack chest, trophy podium, lantern urn, health pickup, meter pickup, score pickup, Dojo, Pavilion, Grand Tournament, and Champion's Courtyard evidence passing at 720p and 1080p.
...
3. **DONE:** The training dummy, all four World Warrior breakable crates (Sparring Supply Crate, Pavilion Rack Chest, Grand Tournament Champion's Trophy Podium, Champion's Lantern Urn), and the Vitality Gourd, Focus Drum, and Judge's Laurel Fan pickups are all runtime approved. The Rack Chest's initial calibration read far too small next to the player character (measured 44% of true mannequin height) and was corrected to 63%; the Trophy Podium (56%) and Lantern Urn (60%) both applied the measured **Proportion and scale calibration** gate from the start and needed no correction. The Sparring Supply Crate (measured 32%) still needs a proportion re-review, scheduled as part of the `Full Proportion Sizing Sweep` in `PROJECT_HANDOFF.md`. Rolling log, falling practice prop, spectator/crowd layers, and arena destruction remain pending.
