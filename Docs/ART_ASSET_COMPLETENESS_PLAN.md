...
Current cross-world verification after the World Warrior Sparring Supply Crate, Pavilion Rack Chest, Grand Tournament Champion's Trophy Podium, Judge's Laurel Fan, walk-cycle QA expansion, and director-level PushZone integration: 240/240 world-run assertions plus 51/51 stage-hazard assertions (291/291 aggregate), with exact Rookie, Striker, Grappler, Kenzo, Makoto, Tetsu, training dummy, supply crate, rack chest, trophy podium, health pickup, meter pickup, score pickup, Dojo, Pavilion, Grand Tournament, and Champion's Courtyard evidence passing at 720p and 1080p.
...
3. **IN PROGRESS:** The first training dummy, the Sparring Supply Crate, the Pavilion Rack Chest, the Grand Tournament Champion's Trophy Podium, and the Vitality Gourd, Focus Drum, and Judge's Laurel Fan pickups are runtime approved. The Rack Chest's initial calibration read far too small next to the player character (measured 44% of true mannequin height) and was corrected to 63%; the Sparring Supply Crate (measured 32%) still needs the same measured proportion re-review before its next touch. The Trophy Podium applied the measured **Proportion and scale calibration** gate from the start (56%) and needed no correction — use that same up-front process for the last remaining crate variant, Champion's Courtyard; rolling log, falling practice prop, spectator/crowd layers, and arena destruction remain pending.
