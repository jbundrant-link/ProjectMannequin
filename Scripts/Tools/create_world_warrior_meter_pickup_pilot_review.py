#!/usr/bin/env python3
"""Create gameplay-scale review proxies for the Focus Drum pilot."""
...
PILOT = Path(
    ...
    "world_warrior_meter_pickup_style_pilot_v1.png"
)
STAGE_CAPTURE = Path(
...
STAGE_PROXY = Path(
    "Artifacts/StyleCalibration/"
    "world_warrior_meter_pickup_pilot_v1_stage_scale_proxy.png"
)
READABILITY_STRIP = Path(
    "Artifacts/StyleCalibration/"
    "world_warrior_meter_pickup_pilot_v1_readability_strip.png"
)
