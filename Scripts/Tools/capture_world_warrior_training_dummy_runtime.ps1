...
$intact = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_training_dummy_intact_runtime_$suffix.png"
$drop = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_training_dummy_break_drop_runtime_$suffix.png"
$collection = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_health_pickup_collection_runtime_$suffix.png"
$log = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_training_dummy_runtime_$suffix.log"
$environment = [ordered]@{
...
try {
    ...
    try {
        ...
        if (-not $passed) {
            throw "Training dummy runtime capture failed validation at $suffix."
        }
    }
    finally {
        if ($intactImage) {
