...
$intact = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_grand_tournament_trophy_podium_intact_runtime_$suffix.png"
$drop = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_grand_tournament_trophy_podium_drop_runtime_$suffix.png"
$collection = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_grand_tournament_trophy_podium_collection_runtime_$suffix.png"
$log = Join-Path $projectRoot "Artifacts\StyleCalibration\world_warrior_grand_tournament_trophy_podium_runtime_$suffix.log"
$environment = [ordered]@{
    ...
    PROJECT_MANNEQUIN_LADDER_PROP_SPRITE_SUFFIX = 'world_warrior_grand_tournament_trophy_podium_style_v1.png'
    PROJECT_MANNEQUIN_LADDER_PICKUP_SPRITE_SUFFIX = 'world_warrior_health_pickup_style_v1.png'
}
$previous = @{}
...
try {
    ...
    try {
        ...
        if (-not $passed) {
            throw "Grand Tournament trophy podium runtime capture failed validation at $suffix."
        }
    }
    finally {
        if ($intactImage) {
